        ...
        <div class="page-content" style="height: 41%">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 ">
                    <img style="height: 75%;width: 106%;margin-top: 1%" src="{{asset(setting()->logo)}}" height="" alt="">
                </div>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 achievements">
        <div class="page-content">
            <div class="home-achivement-heading">
                <h3 style="background: #30654c">পরিচালনা পরিষদ <a href="" class="float-left" style="float: right;color: white;margin-right: 8px">আরো দেখুন...</a> </h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                        ...
                        @forelse(managements() as $info)
                            <div class="photo-slide singCourse_imgarea">
                                <a class="venobox vbox-item" data-gall="gallery01" href="{{asset($info->image)}}">
                                    <img  style="height: 191px; border: 7px solid #30654c" src="{{asset($info->image)}}" class="-mg-fulid w-100" alt="">
                                </a>
                                <div class="bg-danger text-center" style="background: #30654c;padding: 2px;font-weight: bold" >
                                ...
                                <div class="bg-danger text-center" style="padding: 5px;background: #30654c" >
                                    <a href="" class="btn btn-primary p-2"><i class="fa fa-facebook"></i></a>
                                    <a href="" class="btn btn-success p-2"><i class="fa fa-eye"></i></a>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 achievements">
        <div class="page-content">
            <div class="home-achivement-heading">
                <h3 style="background: #30654c">শিক্ষক <a href="" class="float-left" style="float: right;color: white;margin-right: 8px">আরো দেখুন...</a> </h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
