    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    @if(isset($category))
                        <form action="{{route('photo-categories.update',$category->id)}}" method="post"
                              enctype="multipart/form-data">
                            @method('PUT')
                            @else
                                <form action="{{route('photo-categories.store')}}" method="post" enctype="multipart/form-data">
                                    @endif
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            @if(isset($category))
                                                ...
                                                <a href="{{route('photo-categories.index')}}" class="btn btn-danger w-100">
                                                    Cancel</a>
                                            @else
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    @if(isset($category))
                        <a href="{{route('photo-categories.edit',$category->id)}}"
                           class="float-right btn btn-primary">Updating...</a>
                    @else
                        <a href="{{route('photo-categories.index')}}" class="float-right btn btn-primary">List</a>
                    @endif
                    <h5>Menu category</h5>
                </div>
                <div class="card-body">
                        ...
                        @forelse($categories as $info)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <a href="{{route('photo-categories.edit',$info->id)}}" class="btn btn-info"> <i
                                                class="fa fa-edit"></i> </a>
                                        <a href="{{route('photo-categories.edit',$info->id)}}" class="btn btn-danger"> <i
